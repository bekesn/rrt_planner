...
public:
    ...
    static shared_ptr<Control> control(const StateSpaceSimulated& state, const StateSpaceSimulated& target, const float& timeStep);
    ...
    static float getRandomAccel(void);
